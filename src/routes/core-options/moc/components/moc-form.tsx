...
import { AbaContentOutlineTree } from "./aba-content-outline-tree";
...
export function MocForm({ defaultValues, onSubmit, isMutating }: MocFormProps) {
  ...
  function getIndex(board: MocBoard) {
  ...
  return (
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
        <FormSection heading="MOC Providership">
              ...
              render={({ field }) => (
                <FormItem className="flex max-w-2xl flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel>Enable MOC</FormLabel>
                    <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col items-start">
                  ...
                  <FormDescription>Add some helpful text here.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                  ...
                  {fields.some((field) => field.id === board.id) && (
                    ...
                    >
                      <div className="flex items-start gap-4 p-4">
                        <FormField
                          control={form.control}
                          name={`boards.${getIndex(board)}.points`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Points</FormLabel>
                              <FormControl>
                                <Input
                                  className="w-[100px] md:max-w-md"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage />
